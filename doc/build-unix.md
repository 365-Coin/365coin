...
---------------------
	...
	cd src/
	make -f makefile.unix		# Headless 365Coin

See readme-qt.rst for instructions on building 365Coin-Qt, the graphical user interface.
...
---------------------
 ...
 libcrypto++ Cryptography      Provides implementations for cryptography in 365Coin
...
Notes
-----
The release is built with GCC and then `strip 365coind` to strip the debug
...
Security
--------
To help make your 365Coin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, 365Coin should be built with a non-executable stack
