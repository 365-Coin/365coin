    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a 365Coin address (e.g. 3Pf1FRfmnpKSWA6bNZ6pV9mt8mCeyL2STQ)"));
    ui->pubkeyOut_VM->setPlaceholderText(tr("Click \"Sign Message\" to view public key"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a 365Coin address (e.g. 3A4FztWbWTJUD5CWXdfUQDocLSRjdBxwmA)"));
    ui->pubkeyIn_VM->setPlaceholderText(tr("Enter the public key used for signing"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter 365Coin signature"));
#endif
