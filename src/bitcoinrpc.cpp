...
{
    //return GetBoolArg("-testnet", false) ? 18869 : 8869;
    return GetBoolArg("-testnet", false) ? 18869 : 8869;
}
...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "365Coin server stopping";
}
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: 365coin-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
void StartRPCThreads()
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use 365coind";
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("%s, you must set a rpcpassword in the configuration file:\n"
              ...
              "for example: alertnotify=echo %%s | mail -s \"365Coin Alert\" admin@foo.com\n"),
                strWhatAmI.c_str(),
